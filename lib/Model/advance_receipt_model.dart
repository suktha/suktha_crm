class AdvanceReceiptModel {
  ...
  final dynamic companyPrimaryMobile;
  final dynamic companySecondaryMobile;
  ...
  AdvanceReceiptModel.fromJson(Map<String, dynamic> json)
    : id = json['id'] as String?,
      ...
      amountAfterBankCharges = json['amountAfterBankCharges']as double?,
