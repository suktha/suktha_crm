...
class NewLeadManagementAddScreen extends StatefulWidget {
  ...
  @override
  State<NewLeadManagementAddScreen> createState() =>
      _NewLeadManagementAddScreenState();
}

class _NewLeadManagementAddScreenState
    extends State<NewLeadManagementAddScreen> {
  final GlobalKey<FormState> formKey = GlobalKey<FormState>();
  ScrollController _scrollController = ScrollController();
  final GetLocationController locationController =
  ...
  void initState() {
    ...
    Timer(Duration.zero, () {
      if (widget.isEdit == true) {
        ...
        controller.mobileNoController.text = contactController
            .cleanPhoneNumber(widget.leadValue!.mobileNo ?? "");
                ...
                child: Column(
                  children: [
                          ...
                          child: Column(
                              ...
                              children: [
                                                  ...
                                                  onChanged: (value) {
                                                    if (widget
                                                      ...
                                                      controller
                                                          ...
                                                          .value = value;
                                                      print(
                                                          "quick lead bool --${controller.quickLeadisSelected.value}");
                                                      print(
                                                          "status id --${controller.statusId}");
                                                    }
                                                  },
                                                )),
                                          ],
                                ...
                                Obx(
                                  () => Column(
                                    children: [
                                      controller.quickLeadisSelected.value ==
                                              true
                                          ? Column(
                                              children: [
                                                Row(
                                                  children: [
                                                    widget.AddFromContacts ==
                                                            true
                                                        ? Expanded(
                                                            child: Obx(
                                                            () => SizedBox(
                                                                  ...
                                                                  validator:
                                                                    ...
                                                                    if (value!
                                                                      ...
                                                                      return controller
                                                                              .nameList
                                                                              .isNotEmpty
                                                                          ? "Please Select or Enter Lead Name"
                                                ...
                                                Padding(
                                                  ...
                                                  child: TypeAheadField(
                                                    autoFlipDirection: true,
                                                    focusNode:
                                                        _leadStatusfocusNode,
                                                    controller: controller
                                                        .statusController,
                                                    itemBuilder: (context,
                                                        StatusModel itemData) {
                                                      return ListTile(
                                                        title: Text(
                                                            itemData.name!),
                                                      );
                                                ...
                                                if (controller.statusId.value ==
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: TypeAheadField(
                                                      ...
                                                      builder: (context,
                                                          notConvertedcontrollers,
                                                          notConvertedfocusNode) {
                                                        return TextFormField(
                                                          readOnly: true,
                                                          focusNode:
                                                              notConvertedfocusNode,
                                                      ...
                                                      suggestionsCallback:
                                                          (pattern) {
                                                        return controller
                                                            .reasonConversionList;
                                                      },
                                                      onSelected: (suggestion) {
                                                        controller
                                                                .selectedReasonConversionValue =
                                                            suggestion;
                                                        controller
                                                                .notConvertedReasonController
                                                                .text =
                                                ...
                                                Padding(
                                                  ...
                                                  child: TypeAheadField(
                                                    autoFlipDirection: true,
                                                    focusNode:
                                                        _industrySegmentfocusNode,
                                                    controller: controller
                                                        .industrySegmentController,
                                                    builder: (context,
                                                        indsutSegcontrollers,
                                                        indusSegfocusNode) {
                                                      return TextFormField(
                                                        readOnly: true,
                                                        focusNode:
                                                ...
                                                Padding(
                                                  ...
                                                  child: TextFormField(
                                                    ...
                                                    onTap: () {
                                                      ...
                                                      _showInterestProductBottomSheet(
                                                          context: context,
                                                          isMaterial: true,
                                                          materialList: widget
                                                              .materialList,
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(
                                                                ...
                                                                style: TextStyle(
                                                                    fontSize:
                                                                        17.sp,
                                                                    color: controller.isGeneralInfoSelected.value ==
                                                                            true
                                                                        ? Colors
                                                                            .blue
                                                                        : Colors
                                                              ...
                                                              Container(
                                                                decoration: BoxDecoration(
                                                                    border: controller.isGeneralInfoSelected.value ==
                                                                            true
                                                                        ? Border.all(
                                                                            color:
                                                                                kColorlightBlue)
                                                        ...
                                                        children: [
                                                          ...
                                                          Obx(() => Padding(
                                                                ...
                                                                child: controller
                                                                    ...
                                                                    : TypeAheadField<
                                                                        ...
                                                                        suggestionsCallback:
                                                                            (search) =>
                                                                                controller.getCustomerList(search),
                                                                        builder: (context,
                                                                            fieldController,
                                                                            fieldFocusNode) {
                                                                          return TextFormField(
                                                          ...
                                                          Padding(
                                                            ...
                                                            child:
                                                                TypeAheadField(
                                                              focusNode:
                                                                  _conversionChancefocusNode,
                                                              builder: (context,
                                                                  converChancecontrollers,
                                                                  converseChancefocusNode) {
                                                                return TextFormField(
                                                                  readOnly:
                                                                      true,
                                                                  focusNode:
                                                              ...
                                                              suggestionsCallback:
                                                                  (pattern) {
                                                                return controller
                                                                    .conversionChanceList;
                                                              },
                                                              onSelected:
                                                                  (suggestion) {
                                                                controller
                                                                        .selectedConversionChanceValue =
                                                                    suggestion;
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(
                                                                ...
                                                                style: TextStyle(
                                                                    fontSize:
                                                                        17.sp,
                                                                    color: controller.isContactInfoSelected.value ==
                                                                            true
                                                                        ? Colors
                                                                            .blue
                                                                        : Colors
                                                              ...
                                                              Container(
                                                                decoration: BoxDecoration(
                                                                    border: controller.isContactInfoSelected.value ==
                                                                            true
                                                                        ? Border.all(
                                                                            color:
                                                                                kColorlightBlue)
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(
                                                                ...
                                                                style: TextStyle(
                                                                    fontSize:
                                                                        17.sp,
                                                                    color: controller.isAddressInfoSelected.value ==
                                                                            true
                                                                        ? Colors
                                                                            .blue
                                                                        : Colors
                                                              ...
                                                              Container(
                                                                decoration: BoxDecoration(
                                                                    border: controller.isAddressInfoSelected.value ==
                                                                            true
                                                                        ? Border.all(
                                                                            color:
                                                                                kColorlightBlue)
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: [
                                                              ...
                                                              Container(
                                                                decoration: BoxDecoration(
                                                                    border: controller.isMoreSelected.value ==
                                                                            true
                                                                        ? Border.all(
                                                                            color:
                                                                                kColorlightBlue)
                                                            ...
                                                            GestureDetector(
                                                              onTap: () {
                                                                _showBottomTimePicker(
                                                                    ...
                                                                    "Select the Preferred contact Time",
                                                                    false);
                                                              },
                                                              child: CustomTextField(
                                                                  readonly: true,
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(
                                                                ...
                                                                style: TextStyle(
                                                                    fontSize:
                                                                        17.sp,
                                                                    color: controller.isInternalAnalysisSelected.value ==
                                                                            true
                                                                        ? Colors
                                                                            .blue
                                                                        : Colors
                                                              ...
                                                              Container(
                                                                decoration: BoxDecoration(
                                                                    border: controller.isInternalAnalysisSelected.value ==
                                                                            true
                                                                        ? Border.all(
                                                                            color:
                                                                                kColorlightBlue)
                    ...
                    widget.AddFromContacts == true ||
                            widget.editFromContacts == true
                        ? CustomButton(
                            width: 50.w,
                            title: widget.editFromContacts == true
                                ? "Update"
                                : "Done",
                            ...
                            ontap: () async {
                              if (formKey.currentState!.validate()) {
                                ...
                                final logindecoded =
                                    json.decode(prefs.getValue('userMap')!);
                                final loginDetails =
                                    loginModel.LoginModel.fromJson(
                                        logindecoded);

                                final financialYearDetailDEcoded = json
                                    .decode(prefs.getValue('financialYear')!);
                                financialYear = FinancialYearModel.fromJson(
                                    financialYearDetailDEcoded);
                                print(
                                    "index Number 2= ${widget.IndexOfMandatoryField ?? 0}");

                                contactController.isMandatoryFieldAdded[
                                    widget.IndexOfMandatoryField ?? 0] = true;

                                // var mobileNumber = contactController.cleanPhoneNumber(contactController.contactNumbers[widget.IndexOfMandatoryField ?? 0]);

                                contactController.leadList[
                                        widget.IndexOfMandatoryField ?? 0] =
                                    LeadModel(
                                  id: null,
                                  leadName: controller.nameController.text,
                                  mobileNo: controller.mobileNoController.text,
                                  leadGenerationDate: DateClass().parseDate(
                                      controller.leadDateController.text),
                                  followUpDate: DateClass().parseDate(
                                      controller.followUpDateController.text),
                                  leadGenerationId: null,
                                  leadGenerationNumber:
                                      controller.autoNum.value == 0
                                          ? controller
                                                  .leadGenerationNumController
                                                  .text
                                                  .isEmpty
                                  ...
                                  interestedProductId: controller
                                      .selectedMaterialItem
                                      .map<int>((material) => material.id!)
                                      .toList(),
                                  interestedServiceId: controller
                                      .selectedServiceItem
                                      .map<int>((material) => material.id!)
                                      .toList(),
                                  contactPerson:
                                  ...
                                  conversionChanceId: controller
                                          .selectedConversionChanceValue.id ??
                                      0,
                                  countryId:
                                      controller.selectedCountryValue.id ??
                                          null,
                                  deleted: null,
                                  email: controller.emailController.text,
                                  financialYearId: financialYear!.id,
                                  followUpTime: controller.followUpId.value == 0
                                      ? null
                                      : controller.followUpId.value,
                                  isExistingCustomer:
                                      controller.isNewcustomer.value ? null : 1,
                                  leadComments:
                                      controller.leadCommentsControler.text,
                                  leadGenerationType: 35,
                                  partyId:
                                      controller.selectedCustomerValue.id ??
                                          null,
                                  partyName:
                                      controller.selectedCustomerValue.name ??
                                          '',
                                  priorityId:
                                      controller.selectedPriorityValue.id ?? 0,
                                  productName: controller
                                      .intrestedProductController.text,
                                  sourceId:
                                      controller.selectedSourceValue.id ?? 0,
                                  stateId:
                                      controller.selectedStateValue.id ?? null,
                                  statusId:
                                      controller.selectedStatusValue.id ?? null,
                                  statusName: controller.statusController.text,
                                  userComments:
                                      controller.internalCommentsControler.text,
                                  quickLead: 1,
                                  leadOwnerId: controller.selectedUserValue.id,
                                  leadCompanyName:
                                      controller.companyNameController.text,
                                  industrySegmentId:
                                      controller.selectedindusSegmentValue.id,
                                  leadCategoryId:
                                      controller.selectedCategoryuValue.id,
                                  leadDescription:
                                      controller.leadDescriptionController.text,
                                  designationId:
                                      controller.selectedDesignationValue.id,
                                );
                                print(
                                ...
                                customSnackbar(
                                    ...
                                    "Please check everything you entered is correct",
                                    "error");
                              }
                            },
                          )
                              ...
                              if (formKey.currentState!.validate()) {
                                if (widget.isEditFromLeadGen == true) {
                                  ...
                                  controller.UpdateLead(
                                      isLeadGenEdit: widget.isEditFromLeadGen!,
                                      leadGenValues:
                                          widget.leadGenerationValue);
                                } else {
                                  print(
                                      "save lead --${controller.nameController.text}");

                                  controller.saveLead(
                                      isEdit: widget.isEdit,
                                      leadValues: widget.leadValue,
                                      latLong: controller.latAndLong);
                                }
                              } else {
                                customSnackbar(
                                    "Enter The Details Correctly",
  ...
  editFromContactsFunction(int index) async {
    ...
    controller.leadDateController.text =
        widget.leadValue!.leadGenerationDate == null
            ? ""
    ...
    var mobileNumber =
        contactController.cleanPhoneNumber(widget.leadValue!.mobileNo ?? "");
    print(mobileNumber);
    ...
    if (widget.leadValue!.designationId != null) {
      controller.selectedDesignationValue = controller.leadDesignationList
          .firstWhere((value) => value.id == widget.leadValue!.designationId);
    ...
    if (widget.leadValue!.leadCategoryId != null) {
      controller.selectedCategoryuValue = controller.leadCategoryList
          .firstWhere((value) => value.id == widget.leadValue!.leadCategoryId);
    ...
    controller.statusController.text = controller.statusList
            .firstWhere(
                (element) => element.id == controller.selectedStatusValue.id)
            .name ??
        "";

    controller.selectedSourceValue.id = widget.leadValue!.sourceId;
    controller.sourceController.text = controller.sourceList
            .firstWhere(
                (element) => element.id == controller.selectedSourceValue.id)
            .name ??
        "";
  }
  ...
  void _showBottomTimePicker(BuildContext context,
      TextEditingController selectedTimeController, String titleName,
  ...
  void _showInterestProductBottomSheet(
      {required BuildContext context,
      required bool isMaterial,
      required List<MaterialModel> materialList,
      required List<MaterialModel> serviceList}) {
    showModalBottomSheet(
      shape: RoundedRectangleBorder(
...
class TimePickerBotoomSheetWidget extends StatelessWidget {
  ...
  TimePickerBotoomSheetWidget(
      {super.key,
      required this.selectedTimeController,
      required this.title,
      this.isFromFollowUpTime});
                  ...
                  return GestureDetector(
                    onTap: () {
                      ...
                      if (isFromFollowUpTime == true) {
                        ...
                        print(
                            "follow up time- id--2--${controller.followUpId.value}");
                      } else if (isFromFollowUpTime == false) {
                        controller.preferredContactTimeId.value = selectedId;
                        print(
                            "prefered time- id--2--${controller.preferredContactTimeId.value}");
                      }
...
class InterestedProductBottomSheetWidget extends StatefulWidget {
  ...
  const InterestedProductBottomSheetWidget(
      {super.key,
  ...
  @override
  State<InterestedProductBottomSheetWidget> createState() =>
      _InterestedProductBottomSheetWidgetState();
}

class _InterestedProductBottomSheetWidgetState
    extends State<InterestedProductBottomSheetWidget> {
  final controller = Get.put(LeadController());
            ...
            child: Column(
              children: [
                ...
                TextField(
                  onChanged: (value) {
                    widget.isMaterial
                        ? controller.materialSearchResults(
                            query: value, materialLists: widget.materialList)
                        : controller.serviceSearchResults(
                            query: value, serviceLists: widget.serviceList);
                  },
                  decoration: InputDecoration(
                      labelText: 'Search',
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return GestureDetector(
                        onTap: () {
                          setState(() {
                            if (widget.isMaterial) {
                              if (controller.selectedMaterialItem
                                  .contains(item)) {
                              ...
                              if (controller.selectedServiceItem
                                  .contains(item)) {
                            ...
                            if (widget.isMaterial) {
                              controller.intrestedProductController.text =
                                  controller.selectedMaterialItem
                                      .map((item) => item.name)
                                      .join(', ');
                            } else {
                              controller.intrestedServiceController.text =
                                  controller.selectedServiceItem
                                      .map((item) => item.name)
                                      .join(', ');
                            }
                          });
                        ...
                        child: ListTile(
                          ...
                          trailing: Checkbox(
                            value: widget.isMaterial
                                ? controller.selectedMaterialItem.contains(item)
                                : controller.selectedServiceItem.contains(item),
