...
import 'package:work_Force/view/screens/My_account/view/module/Company%20Account%20Settings/widgets/pdfviewScreen.dart';
...
class LeadDocumentWalletScreen extends StatelessWidget {
  const LeadDocumentWalletScreen(
  ...
  Widget build(BuildContext context) {
    return PopScope(
      onPopInvoked: (didPop) {
        ...
        controller.isSelectedDocuments
            .fillRange(0, controller.isSelectedDocuments.length, false);
      },
      child: Container(
        height: 70.h,
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        child: IconButton(
                            onPressed: () {
                              controller.multiSelectMode.value = false;
                              controller.isSelectedDocuments.fillRange(0,
                                  controller.isSelectedDocuments.length, false);
                              Get.back();
                            },
                            icon: Icon(
                              Icons.close,
                          ...
                          ? Expanded(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  var walletItem =
                                      controller.documentWalletList[index];
                                  return FadeInRightBig(
                                    duration: const Duration(
                                        milliseconds:
                                            500), // Set the duration of each animation
                      ...
                      ? InkWell(
                          onTap: () async {
                            customDeleteAlertDialogue(
                              context,
                              () async {
                                List<String> payload = controller
                                    .documentWalletList
                                    .asMap()
                                    .entries
                                    .where((entry) => controller
                                        .isSelectedDocuments[entry.key])
                                ...
                                controller.deleteDocument(
                                    payload, leadValue.id!);

                                Get.back();
                                customSnackbar(
                                    "Delete", "Successfully Deleted", "error");

                                controller.multiSelectMode.value = false;
                                controller.isSelectedDocuments.fillRange(
                                    0,
                                    controller.isSelectedDocuments.length,
                                    false);
                              },
                            );
                          },
                              ...
                              if (file != null) {
                                ...
                                if (fileSizeInMB > 1) {
                                  customSnackbar("Error",
                                      "File size cannot exceed 1MB", "error");
                                } else {
