...
class SubscriptionController extends GetxController {
  ...
  getSubscriptionDetails() async {
    Map<String, dynamic> response = await apiCallService(
        "/PaymentDetails", "GET", {}, TheResponseType.map, {}, false);
  ...
  Future<List<SubHistoryModel>> getSubscriptionHistoryList() async {
    try {
      List<dynamic> response = await apiCallService(
          "/subscriptionList", "GET", {}, TheResponseType.list, {}, false);
      List<SubHistoryModel> userDatas =
          response.map((e) => SubHistoryModel.fromJson(e)).toList();
