...
//   void initState() {
//     super.initState();
//     controller.getExpenseHeadDetails();
//   }
...
//                                       () async {
//                                         print(items.id);
//                                         controller.deleteExpenseHeadDetails(items.id);
//                                         Get.back();
//                                       },
//                                     );
//                                   },
...
//                                 onTap: () {
//                                   controller.expenseNameController.text = controller.expense_head_items[index].name;
//                                   showDialog(
//                                     context: context,
//                                     builder: (context) {
//                                       return Form(
...
//                                                   controller.editExpenseHeadDetails(id: controller.expense_head_items[index].id ?? 0, delete: controller.expense_head_items[index].deleted ?? '');
//                                                   Get.back();
...
//                                                                     id: controller.expense_head_items[index].id ?? 0, delete: controller.expense_head_items[index].deleted ?? '');
//                                                                 Get.back();
