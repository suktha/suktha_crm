...
//         child: AppBar(
//             title: const Text("Country Master"),
//             actions: [
//               IconButton(
//                   onPressed: () async {
...
//                                 onTap: () {
//                                   print("ontapped");
//                                   controller.countryNameController.text = controller.country_master_items[index].name ?? "";
//                                   controller.countryCodeController.text = controller.country_master_items[index].countryCode ?? "";
...
//                                                 controller.editCountryDetails(id: controller.country_master_items[index].id ?? 0, delete: controller.country_master_items[index].deleted ?? '');
//                                                 Get.back();
...
//                                                                   id: controller.country_master_items[index].id ?? 0, delete: controller.country_master_items[index].deleted ?? '');
//                                                               Get.back();
