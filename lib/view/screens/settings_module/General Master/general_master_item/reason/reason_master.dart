...
//                                   controller.reasonNameController.text = item.name!;
...
//                                                   obscure: false,
//                                                   controller: controller.reasonNameController,
//                                                   label: 'Reason Name'),
//                                             ],
//                                             title: "Edit",
//                                             onCancelPressed: () {
...
//                                                 var value = IndustrySegmentModel(id: item.id, name: controller.reasonNameController.text, deleted: item.deleted);
//                                                 controller.reason_items.add(value);
//                                                 var values = controller.reason_items.map((element) => element.toJson()).toList();

//                                                 controller.postReason(true, values);
//                                               } else {
