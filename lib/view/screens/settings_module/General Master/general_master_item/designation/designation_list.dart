...
//   void initState() {
//     super.initState();
//     controller.getDesignationDetails();
//   }
...
//                                 onTap: () {
//                                   controller.designationNameController.text = controller.designation_items[index].designationName;
//                                   showDialog(
//                                     context: context,
//                                     builder: (context) {
//                                       return Form(
...
//                                                   controller.editDesignationDetails(id: controller.designation_items[index].id ?? 0, delete: controller.designation_items[index].deleted ?? '');
//                                                   Get.back();
...
//                                                                     id: controller.designation_items[index].id ?? 0, delete: controller.designation_items[index].deleted ?? '');
//                                                                 Get.back();
