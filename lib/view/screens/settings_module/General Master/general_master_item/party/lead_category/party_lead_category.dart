...
//   @override
//   State<LeadCategoryMasterScreen> createState() => _LeadCategoryMasterScreenState();
// }
...
//         child: AppBar(
//             title: const Text("Party/Lead Category"),
//             actions: [
//               IconButton(
//                   onPressed: () async {
...
//                                 onTap: () {
//                                   print("ontapped");
//                                   var item = controller.customer_class_items[index];
//                                   controller.categoryNameController.text = item.name;
...
//                                                 var value = CustomerClassificationModel(id: item.id, name: controller.categoryNameController.text, deleted: item.deleted);
//                                                 controller.customer_class_items.add(value);
//                                                 var values = controller.customer_class_items.map((element) => element.toJson()).toList();
