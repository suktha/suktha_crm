...
// import 'package:suktha/Model/Industry_Segment_Model.dart';
// import 'package:suktha/Model/customer_classification_model.dart';
...
//   IndustrySegmentMasterScreen({super.key});

//   @override
//   State<IndustrySegmentMasterScreen> createState() => _IndustrySegmentMasterScreenState();
// }

// class _IndustrySegmentMasterScreenState extends State<IndustrySegmentMasterScreen> {
...
//   void initState() {
//     super.initState();
//     controller.getIndustrySegmentDetails();
//   }
...
//         child: AppBar(
//             title: const Text("Industry Segment"),
//             actions: [
//               IconButton(
//                   onPressed: () async {
...
//               ),
//             ),
//             titleTextStyle: TextStyle(color: kColorblack, fontWeight: FontWeight.bold, fontSize: 16.sp),
//             centerTitle: false,
...
//                               child: Text(
//                                 "Your Industry Segment Category is Empty ",
...
//                           var items = controller.searchIndusSegmentResults[index];
...
//                                       () async {
//                                         print(items.id);
//                                         controller.deleteIndustrySegmentDetails(items.id);
//                                         Get.back();
//                                       },
//                                     );
//                                   },
...
//                                 onTap: () {
//                                   print("ontapped");
//                                   var item = controller.industry_segment_items[index];
//                                   controller.indusSegNameController.text = item.name!;
...
//                                                   obscure: false,
//                                                   controller: controller.indusSegNameController,
...
//                                                 var value = IndustrySegmentModel(id: item.id, name: controller.indusSegNameController.text, deleted: item.deleted);
//                                                 controller.industry_segment_items.add(value);
//                                                 var values = controller.industry_segment_items.map((element) => element.toJson()).toList();

//                                                 controller.postIndustrySegmentCategory(true, values);
//                                               } else {
...
//                                       title: Text(
//                                         "Name",
//                                         style: TextStyle(fontWeight: FontWeight.w400, color: Colors.grey.shade700, fontSize: 15),
//                                       ),
//                                       subtitle: Text(
//                                         "${items.name}",
//                                         style: TextStyle(fontWeight: FontWeight.w700, color: kColorblack, fontSize: 16),
//                                       ),
//                                       trailing: Row(
...
//                                     onUpdatePressed: () {
//                                       if (formKey.currentState!.validate()) {
//                                         controller.postIndustrySegmentCategory();
//                                       } else {
